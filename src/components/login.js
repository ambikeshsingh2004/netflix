...
https://assets.nflxext.com/ffe/siteui/vlv3/21a8ba09-4a61-44f8-8e2e-70e949c00c6f/6678e2ea-85e8-4db2-b440-c36547313109/IN-en-20240722-POP_SIGNUP_TWO_WEEKS-perspective_WEB_3457a8b1-284d-4bb5-979e-2a2e9bb342b3_small.jpg" alt = "img"/>
      ...
      <form className ="p-12 absolute w-full md:w-1/3  bg-opacity-70 mx-auto my-36 left-0 right-0 flex flex-col text-white rounded-lg bg-black">
      <h1 className = "font-bold text-3xl p-2 ">{issign ? "Sign In" :"Sign Up"}</h1>
        ...
        <input type  = "text" placeholder = "Email Address" className ="p-2 m-2 bg-slate-600"/>
        <input type  = "text" placeholder = "Password" className ="p-2 m-2 bg-slate-600"/>
        <button className = "p-2 m-2 bg-red-600">{issign ? "Sign In" :"Sign Up"}</button>
